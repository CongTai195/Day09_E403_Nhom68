...
def supervisor_node(state: AgentState) -> AgentState:
    ...
    # 1. Retrieval priority (P1, escalation, ticket)
    ...
    if any(kw in task for kw in policy_keywords):
        ...
        route = "retrieval_worker"
        route_reason = "default retrieval: general query"

    # Additional risk check (emergency or high level access)
    if "emergency" in task or "level 3" in task:
        risk_high = True
...
if __name__ == "__main__":
    ...
    test_queries = [
        ...
        "Hệ thống báo mã lỗi không rõ ERR-999 khi sync data.",
    ]
